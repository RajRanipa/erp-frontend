...
export default function SubmitButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        'relative inline-flex items-center justify-center gap-2 rounded-md px-4 py-2 font-medium text-[#fff] transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2',
        isDisabled
