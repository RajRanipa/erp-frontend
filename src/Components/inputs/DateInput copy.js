...
const DateInput = ({
  ...
  useEffect(() => {
    ...
    presetLabelMap[preset]?.toLowerCase() === 'today' ? onLabelChange?.(formatDate(today) || '')  : onLabelChange?.(presetLabelMap[preset] || '') 
      ...
      <div className="relative flex items-center gap-2">
        ...
        {(mode === 'single' || (mode === 'range' && !isCustomRange)) && (
          <>
            ...
            <input
              type={
                  selectedPreset?.toLowerCase() === 'today' ? 'date' : mode === 'range' && !isCustomRange
                  ? 'text'
                  : 'date'
              }
              name={name}
              ...
              {[
                ...
                <li
                  ...
                  onClick={() => {
                    ...
                    setIsCustomRange(false);
                    item.label?.toLowerCase() === 'today' ? onLabelChange?.(formatDate(today)|| '') : onLabelChange?.(item.label);
