...
export default function SubmitButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        'relative inline-flex h-fit items-center capitalize focus:bg-teal-800 justify-center gap-2 rounded-lg px-3.5 py-1.5 font-medium text-white transition-colors duration-200 focus:outline-none focus:ring-teal-800 focus:ring-2 focus:ring-offset-2 ',
        isDisabled
