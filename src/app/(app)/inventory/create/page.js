...
import ProductParametersComponent from '@/(app)/items/components/ProductParameters';
import CoreProductFieldsComponent from '@/(app)/items/components/CoreProductFields';
import ParameterToggleBarComponent from '@/(app)/items/components/ParameterToggleBar';
...
export default function AddProductPage() {
    ...
    const handleSubmit = useCallback(async (e) => {
        ...
        try {
            ...
            console.error('Error creating product: not', error);
                toast({
                    type: "error",
        ...
        <Inventory>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div className='grid grid-cols-3 gap-4 grid-rows-[min-content]' >
                    ...
                    <div className='col-span-3 bg-most-secondary p-4 rounded-lg flex flex-col items-start justify-start gap-2 shadow-sm'>
