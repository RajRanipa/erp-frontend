    ...
    <div className={`mb-5 w-full ${parentClass}`}>
      ...
      <div className="relative">
        ...
        <textarea
          ...
          ref={ref}
          rows={rows}
          className={cn(`block w-full rounded-lg border shadow-xs px-3 py-2 text-most-text focus:outline-none focus:border-0.5 focus:ring-3 focus:ring-blue-500/30 focus:border-blue-500 sm:text-sm resize-y
            ${className}
            ${icon ? 'pl-10' : ''}
